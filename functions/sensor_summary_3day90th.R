...
daily_summary_3day90th <- function(df) {
    ...
    for(d in 2:days_to_loop) {
        ...
        if(sensor_name %in% sensors_at_B) {
            ...
            output_df[d, "sm5cm_daily_min"] <- min(subset_day$vwcb_5cm_Avg, na.rm = TRUE)
            output_df[d, "sm30cm_daily_min"] <- min(subset_day$vwcb_30cm_Avg, na.rm = TRUE)
            output_df[d, "sm5cm_daily_10th"] <- quantile(subset_day$vwcb_5cm_Avg, 0.1, na.rm = TRUE)
            output_df[d, "sm30cm_daily_10th"] <- quantile(subset_day$vwcb_30cm_Avg, 0.1, na.rm = TRUE)
            output_df[d, "sm5cm_daily_25th"] <- quantile(subset_day$vwcb_5cm_Avg, 0.25, na.rm = TRUE)
            output_df[d, "sm30cm_daily_25th"] <- quantile(subset_day$vwcb_30cm_Avg, 0.25, na.rm = TRUE)
            ...
            output_df[d, "sm30cm_3day90th"] <- quantile(subset_3day$vwcb_30cm_Avg, 
                                                        0.9, na.rm = TRUE)
            output_df[d, "sm5cm_3day10th"] <- quantile(subset_3day$vwcb_5cm_Avg, 0.1, na.rm = TRUE)
            output_df[d, "sm30cm_3day10th"] <- quantile(subset_3day$vwcb_30cm_Avg, 0.1, na.rm = TRUE)
            output_df[d, "sm5cm_3day25th"] <- quantile(subset_3day$vwcb_5cm_Avg, 0.25, na.rm = TRUE)
            output_df[d, "sm30cm_3day25th"] <- quantile(subset_3day$vwcb_30cm_Avg, 0.25, na.rm = TRUE)
        }
        if(sensor_name == 15) {
            ...
            output_df[d, "sm5cm_daily_min"] <- min(subset_day$vwca_5cm_Avg, na.rm = TRUE)
            output_df[d, "sm30cm_daily_min"] <- min(subset_day$vwca_30cm_Avg, na.rm = TRUE)
            output_df[d, "sm5cm_daily_10th"] <- quantile(subset_day$vwca_5cm_Avg, 0.1, na.rm = TRUE)
            output_df[d, "sm30cm_daily_10th"] <- quantile(subset_day$vwca_30cm_Avg, 0.1, na.rm = TRUE)
            output_df[d, "sm5cm_daily_25th"] <- quantile(subset_day$vwca_5cm_Avg, 0.25, na.rm = TRUE)
            output_df[d, "sm30cm_daily_25th"] <- quantile(subset_day$vwca_30cm_Avg, 0.25, na.rm = TRUE)
            ...
            output_df[d, "sm5cm_3day10th"] <- quantile(subset_3day$vwca_5cm_Avg, 0.1, na.rm = TRUE)
            output_df[d, "sm30cm_3day10th"] <- quantile(subset_3day$vwca_30cm_Avg, 0.1, na.rm = TRUE)
            output_df[d, "sm5cm_3day25th"] <- quantile(subset_3day$vwca_5cm_Avg, 0.25, na.rm = TRUE)
            output_df[d, "sm30cm_3day25th"] <- quantile(subset_3day$vwca_30cm_Avg, 0.25, na.rm = TRUE)
        ...
        if(sensor_name == 21) {
            ...
            output_df[d, "sm5cm_daily_min"] <- min(subset_day$vwcc_5cm_Avg, na.rm = TRUE)
            output_df[d, "sm30cm_daily_min"] <- min(subset_day$vwcc_30cm_Avg, na.rm = TRUE)
            output_df[d, "sm5cm_daily_10th"] <- quantile(subset_day$vwcc_5cm_Avg, 0.1, na.rm = TRUE)
            output_df[d, "sm30cm_daily_10th"] <- quantile(subset_day$vwcc_30cm_Avg, 0.1, na.rm = TRUE)
            output_df[d, "sm5cm_daily_25th"] <- quantile(subset_day$vwcc_5cm_Avg, 0.25, na.rm = TRUE)
            output_df[d, "sm30cm_daily_25th"] <- quantile(subset_day$vwcc_30cm_Avg, 0.25, na.rm = TRUE)
            output_df[d, "sm5cm_3day90th"] <- quantile(subset_3day$vwcc_5cm_Avg, 0.9, na.rm = TRUE)
            output_df[d, "sm5cm_3day10th"] <- quantile(subset_3day$vwcc_5cm_Avg, 0.1, na.rm = TRUE)
            output_df[d, "sm30cm_3day90th"] <- quantile(subset_3day$vwcc_30cm_Avg, 0.9, na.rm = TRUE)
            output_df[d, "sm5cm_3day10th"] <- quantile(subset_3day$vwcc_5cm_Avg, 0.1, na.rm = TRUE)
            output_df[d, "sm30cm_3day10th"] <- quantile(subset_3day$vwcc_30cm_Avg, 0.1, na.rm = TRUE)
            output_df[d, "sm5cm_3day25th"] <- quantile(subset_3day$vwcc_5cm_Avg, 0.25, na.rm = TRUE)
            output_df[d, "sm30cm_3day25th"] <- quantile(subset_3day$vwcc_30cm_Avg, 0.25, na.rm = TRUE)
